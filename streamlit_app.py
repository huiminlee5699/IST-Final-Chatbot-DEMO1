...
# Fix for the deprecation warning - replace experimental_get_query_params
streamlit_analytics._get_query_params = lambda: dict(st.query_params)

# Initialize analytics tracking in a way that doesn't take over the interface
try:
    with streamlit_analytics.track():
        ...
        # Admin section in sidebar (properly contained within the tracking context)
        with st.sidebar:
    ...
    # Continue with the main app functionality if analytics fails
    pass
